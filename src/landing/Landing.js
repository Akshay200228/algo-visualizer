    ...
    return (
        <motion.div
            ...
            <Row className="landing__first">
                <Col xs={12} md={6} className="landing__left">
                    ...
                    <div className="landing__text">
                        ...
                        <span className="landing__text-sub__title"> we will play with them :)</span>
                    </div>
                    ...
                    <div className="landing__buttons">
                        ...
                        <Link to="/path-finder">
                            <button className="landing__buttons-path">Find your
                             <span className="strikeout"> Goal</span> path</button>
                        </Link>
                    </div>
                </Col>
            ...
            <Row className="landing__second">
                ...
                <Col xs={12} md={6} className="landing__right">
                    <a href="https://personal-portfolio-theta-nine.vercel.app/" target="_blank" rel="noopener noreferrer">
